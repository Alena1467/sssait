...
if (!class_exists('ReDiRestaurantReservation')) {
    ...
    class ReDiRestaurantReservation
    {
        ...
        public function shortcode($attributes)
        {
            ...
            $dates = $this->redi->getBlockedDates(self::lang(), $categoryID, array(
        ...
        function redi_restaurant_ajax()
        {
            ...
            switch ($_POST['get']) {
                ...
                case 'get_disabled_dates':
                    ...
                    $dates = $this->redi->getBlockedDates(str_replace('_', '-', get_locale()), $categoryID, array(
                        'StartTime' => date('Y-m-d'),
                    ...
                    $startDate = date('Y-m-d', $reservationStartTime);
